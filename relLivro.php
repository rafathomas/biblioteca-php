...
<body>
	...
	<?php
		...
		$sqldados = mysqli_query($con,$sql);
	
		$sqltotaldados = mysqli_num_rows($sqldados);
	if($sqltotaldados > 0)
	{
	...
	?>
		...
		<center><TABLE borders=1 bgcolor= #D8D8D8 fontcolor= #000000></center> 
			<tr>
				<br><CAPTION>INFORMAÇÕES</CAPTION></br>
	...
	<?php
		for($i = 0; $i < $sqltotaldados; $i++)
		{
			$dados = mysqli_fetch_assoc($sqldados);
...
<?php
	...
	echo "<h1> <center> Não a registros no banco</h1></center>";
	echo "<p align=center> <a href=cadContato.php class=botao> DESEJA ADICIONAR UM LIVRO? </a>";
}	
?>
</body>
</html>